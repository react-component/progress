...
var Line = React.createClass({
  render() {
    ...
    ['strokeWidth', 'strokeColor', 'trailWidth', 'trailColor'].forEach(function (item, i, arr) {
      if (item === 'trailWidth' && !_this.props.trailWidth && _this.props.strokeWidth) {
        _this.props.trailWidth = _this.props.strokeWidth;
        return;
      }
      if (item === 'strokeWidth' && _this.props.strokeWidth && (!parseFloat(_this.props.strokeWidth) ||
        parseFloat(_this.props.strokeWidth) > 100 || parseFloat(_this.props.strokeWidth) < 0)
      ) {
